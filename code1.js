...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11161084);
}
}
if (isConditionTrue_0) {
...
isConditionTrue_0 = false;
{
isConditionTrue_1 = gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().getFromIndex(0)) == "NotStarted";
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
}
{
isConditionTrue_1 = gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().getFromIndex(0)) == "GamePlaying";
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
}
}
...
};gdjs.GameCode.asyncCallback11175676 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.GameCode.asyncCallback11175676(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11173604);
}
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11165452);
}
if (isConditionTrue_0) {
{gdjs.evtTools.runtimeScene.resetTimer(runtimeScene, "pipe_spawn");
}}
...
{gdjs.evtTools.storage.readNumberFromJSONFile("save", "high_score", runtimeScene, runtimeScene.getScene().getVariables().getFromIndex(2));
    ...
    gdjs.GameCode.GDHighScoreObjects4[i].getBehavior("Text").setText("Best: " + runtimeScene.getScene().getVariables().getFromIndex(2).getAsString());
}
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().getFromIndex(1)) >= runtimeScene.getScene().getVariables().getFromIndex(2).getAsNumber();
if (isConditionTrue_0) {
...
{for(var i = 0, len = gdjs.GameCode.GDPlayerNameInputObjects3.length ;i < len;++i) {
    gdjs.GameCode.GDPlayerNameInputObjects3[i].getBehavior("Text").setText(runtimeScene.getGame().getVariables().getFromIndex(0).getAsString());
}
}}
...
};gdjs.GameCode.asyncCallback11179052 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.GameCode.localVariables);
...
{for(var i = 0, len = gdjs.GameCode.GDFlashObjects3.length ;i < len;++i) {
    ...
    gdjs.GameCode.GDFinalScoreObjects3[i].getBehavior("Text").setText("Score: " + runtimeScene.getScene().getVariables().getFromIndex(1).getAsString());
}
}
{ //Subevents
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.GameCode.asyncCallback11179052(runtimeScene, asyncObjectsList)));
}
}
...
isConditionTrue_0 = gdjs.playerAuthentication.isAuthenticated();
if (isConditionTrue_0) {
{gdjs.evtTools.leaderboards.saveConnectedPlayerScore(runtimeScene, "33ae5fd6-a214-4948-99da-3edd4d363ca3", runtimeScene.getScene().getVariables().getFromIndex(1).getAsNumber());
}}
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("PlayerNameInput"), gdjs.GameCode.GDPlayerNameInputObjects3);
{gdjs.evtTools.leaderboards.savePlayerScore(runtimeScene, "33ae5fd6-a214-4948-99da-3edd4d363ca3", runtimeScene.getScene().getVariables().getFromIndex(1).getAsNumber(), (( gdjs.GameCode.GDPlayerNameInputObjects3.length === 0 ) ? "" :gdjs.GameCode.GDPlayerNameInputObjects3[0].getText()));
}{runtimeScene.getGame().getVariables().getFromIndex(0).setString((( gdjs.GameCode.GDPlayerNameInputObjects3.length === 0 ) ? "" :gdjs.GameCode.GDPlayerNameInputObjects3[0].getText()));
}}
...
let isConditionTrue_0 = false;
{
{gdjs.evtTools.leaderboards.displayLeaderboard(runtimeScene, "33ae5fd6-a214-4948-99da-3edd4d363ca3", true);
}}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11178908);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.leaderboards.hasBeenSaved("33ae5fd6-a214-4948-99da-3edd4d363ca3");
}
if (isConditionTrue_0) {
